...
- [x] Предметная модель доведена до содержательной редакции 11: 39 нумерованных пунктов плюс нулевой; редакция 12 не меняет текст и фиксирует 42 сохранённых состояния согласования.
- [x] Нулевой пункт согласован целиком: статус сохранён для самого пункта и всех 20 его строк.
- [x] Зафиксированы удаляемый до подтверждения черновик `P` без возврата номера, один исполнитель заявки, редактирование заявки с полной историей без change-request и отказ с видимым комментарием.
...
- [ ] Продолжить пользовательское согласование оставшихся оранжевых/синих нумерованных пунктов текущей редакции; нулевой пункт повторно не открывать без нового противоречащего решения владельца.
