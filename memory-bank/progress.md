...
## 12.09.2026 — единый селектор магазина в «Стикеры и КИЗы»
...
- [x] В обоих местах совпадают подпись, native-select, размеры, рамка, фокус, placeholder и формат `Юридическое название — Название магазина`; прежняя бизнес-фильтрация списков сохранена.
