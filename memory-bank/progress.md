...
- [x] Предметная модель доведена до редакции 11: 39 нумерованных пунктов плюс нулевой, 31 явно сохранённое согласованное состояние.
...
- [ ] Продолжить пользовательское согласование оставшихся оранжевых/синих пунктов текущей редакции; автоматический аудит согласование не заменяет.
