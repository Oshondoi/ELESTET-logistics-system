...
- Реестры `fulfillment_supply_number_registry` и `fulfillment_box_barcode_registry` навсегда сохраняют выданные номера; удалённые номера и QR повторно не используются.
