...
## В работе 04.09.2026 — официальная временная шкала FBS
...
- [ ] Получить действующую авторизацию Supabase, применить SQL, добавить Vault-секреты и развернуть `wb-fbs`.
- [ ] Запустить теневое восстановление, сравнить старый и новый отчёты, затем отправить frontend в `main` и `master`.
