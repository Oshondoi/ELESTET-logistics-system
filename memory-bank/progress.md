...
- [x] Предметная модель доведена до редакции 16: полный текст сохранён, 40 нумерованных пунктов плюс нулевой; в БД сохранены 168 состояний согласования.
...
- [ ] Завершить пункт 8: определить `A-N` при переносе магазина между компаниями, восстановлении магазина с уже выданным `A-N` и восстановлении одного из 33 старых магазинов без номера.
