...
- Master-checkbox встроен в шапку таблицы; массовые печать, перенос и отгрузка вынесены в плавающую нижнюю панель со счётчиком выбора
...
### FBS — skus тип
- `skus` убран из upsert payload (jsonb vs text[] mismatch в PostgREST)
