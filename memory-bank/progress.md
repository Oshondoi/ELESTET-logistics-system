...
- [x] Активное предметное обсуждение обновлено до редакции 9: все 38 блоков сохранены, 18 связанных блоков исправлены одновременно, старые конфликтующие конструкции удалены из актуальной версии.
...
- [ ] Владелец должен просмотреть и явно согласовать нулевой и остальные блоки редакции 9; автоматический аудит согласование не заменяет.
