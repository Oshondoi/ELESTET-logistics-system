...
- Вкладка `Обсуждение` использует четыре состояния цвета по двум независимым осям происхождения и согласования: оранжевый, фиолетовый, синий и зелёный. Состояния применяются к пунктам, строкам, навигации, бейджам и полосам чёрных схем.
...
- Блоки `##` и их маркированные/нумерованные строки имеют независимые состояния `В обсуждении / Согласовано`. Галочки сохраняются в `item_states` текущей записи и ревизии. Чёрные code-блоки не участвуют в согласовании.
