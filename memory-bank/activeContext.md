...
- На каждой поставке: кнопка «Отгрузить всё» (всю поставку разом)
...
- При выборе заказов снизу по центру появляется компактная плавающая панель со счётчиком, массовой печатью, переносом и отгрузкой
...
- **«Создать поставку»**: поле имени (дефолт «Сборка ДД.ММ.ГГГГ»), кнопка «Создать и добавить»
