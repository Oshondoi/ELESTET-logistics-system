...
- Production-default для существующих и новых стеллажей: лицевая/задняя стороны, каждая `2×4 = 8` мест. Нумерация идёт слева направо, затем сверху вниз: `K1 K2 / K3 K4 / K5 K6 / K7 K8`.
