...
## Current Focus (04.05.2026)
Реализован полный модуль **История изменений этапа Маркировка** — полный паритет с ОТК-историей.
Исправлена критическая ошибка: удалённые логи маркировки теперь сразу отображаются красными табами в модалке истории, даже до нажатия «Сохранить».
