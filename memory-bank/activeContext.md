...
## CURRENT FOCUS — 25.09.2026: связно согласуемая редакция 16

- Активное обсуждение `Заявки клиентов, передача партий и фактическая приёмка` находится в редакции 16: полный текст сохранён, 40 нумерованных пунктов плюс нулевой; полученные решения сразу отмечены согласованными, открытыми оставлены три вопроса пункта 8 о переносе и восстановлении магазинов.
...
- UI discussion production: компактная неподвижная шапка, внутренний scroll контента, цветовая вертикальная навигация с автопрокруткой, локальный черновик галочек и единое явное сохранение опубликованы до текущей редакции 16.
