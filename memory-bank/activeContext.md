...
- Production SQL применён, `WB-GI-275897127` точечно получила `available_on_wb=false`, Edge Function `wb-fbs` опубликована как version 63 с прежним `verify_jwt=true`. Frontend build прошёл; commit/push ещё предстоит.
