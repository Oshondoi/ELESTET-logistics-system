...
## CURRENT FOCUS — 25.09.2026: связно согласуемая редакция 9

- Активное обсуждение `Заявки клиентов, передача партий и фактическая приёмка` переведено в редакцию 9: сохранены 38 блоков, а 18 взаимозависимых блоков синхронно обновлены после полного аудита цепочки заявки, прав, партии, приёмки, поставок, коробов, QR, событий и реализации.
...
- Редакция 9 прошла автоматический поиск старых конфликтующих терминов и связей, но ещё не считается согласованной владельцем: после содержательной правки `item_states` сброшены и требуют явного просмотра и сохранения.
- UI discussion production: компактная неподвижная шапка, внутренний scroll контента, цветовая вертикальная навигация с автопрокруткой, локальный черновик галочек и единое явное сохранение опубликованы до формирования редакции 9.
