...
## CURRENT FOCUS — 12.09.2026: единый селектор магазина в «Стикеры и КИЗы»
...
- Источники магазинов не расширялись и не подменялись: импорт стикеров по-прежнему показывает магазины с WB API-ключом; КИЗы сохраняют прежний набор и прежнюю сортировку с подключёнными Teksher-магазинами первыми. Удалены только цветные точки и кастомная механика раскрытия.
