...
- TypeScript и production build проходят. Перед заменой production-записи подтверждено: активное обсуждение `public-request-invite-auth-20260926` уже имеет редакцию 1, 2185 символов, 0 архивных ревизий и 0 ручных отметок; подготовлен транзакционный reset с сохранением текущего текста как новой начальной редакции.
