...
- В текущей модели `wms_zones` — целый стеллаж, а не отдельная сторона или произвольная складская зона.
...
- Стеллаж имеет строго одну или две стороны со стабильными кодами `S1`/`S2` и редактируемыми названиями.
