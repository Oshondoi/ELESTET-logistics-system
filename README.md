...
- K-места нумеруются слева направо и сверху вниз. В паллетоместе они отображаются физической сеткой, а не одной горизонтальной строкой.
- Свободное место создаёт новый короб. Занятый короб можно перенести в свободное место или атомарно поменять местами с другим коробом.
...
- SQL: `supabase/patch_wms.sql`, `patch_wms_boxes.sql`, `patch_wms_disabled.sql`, `patch_wms_rack_layout.sql`.
