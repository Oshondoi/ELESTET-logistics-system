...
| `sold`, `canceled_by_client`, `defect` | Завершённые |
| `cancel`, `declined_by_client`, `canceled` | Отменённые |
| строка вне последнего 30-дневного снимка или неизвестная официальная комбинация | Архив |
