...
## Актуальное состояние разработки — 15.08.2026
...
- QR паллетоместа имеет формат `C{компания}_W{склад}_R{стеллаж}_S{сторона}_{адрес}`, например `C52_W1_R1_S1_A1`; QR конкретного коробоместа дополняется номером K: `C52_W1_R1_S1_A1_K6`.
...
- Операционный адрес короба: `Название стороны · B3-K5`, например `Сторона 1 · B3-K5`; склад и стеллаж задают вышестоящий контекст. Внутри системы стороны имеют стабильные коды `S1`, `S2`, поэтому переименование не ломает адресные связи.
