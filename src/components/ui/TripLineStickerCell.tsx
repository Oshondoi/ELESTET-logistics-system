...
export const TripLineStickerCell = ({ fileUrls, combinedUrls = [], wbSupplyId, passUrls = [], onAdd, onRemove, onAddCombined, onRemoveCombined, onFetchWbBarcodes, onUploadPass, onRemovePass }: TripLineStickerCellProps) => {
